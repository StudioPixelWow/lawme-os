...
export const SOURCE_REGISTRY: readonly RegisteredSource[] = [
  ...
  {
    sourceKey: "il-professional-commentary",
    displayNameHe: "פרסומים מקצועיים ומאמרים משפטיים ציבוריים",
    sourceOwner: "מפרסמים מקצועיים (ציבורי)",
    homeUrl: null,
    workstream: "L_public_secondary",
    classification: "DISCOVERY_ONLY",
    authorityTier: "professional_commentary",
    officialStatus: "secondary",
    reuseBasisRef: null,
    licenseOnFile: false,
    requiresExternalApproval: false,
    notesHe: "קטגוריה מוצהרת — פרשנות מקצועית ציבורית; גילוי בלבד. נדרש מקור/פיד קונקרטי בעל רישיון פתוח לפני קליטה.",
  },
  {
    sourceKey: "il-public-legal-articles",
    displayNameHe: "מאמרים, בלוגים ושאלות-תשובות משפטיות ציבוריות",
    sourceOwner: "מקורות ציבוריים",
    homeUrl: null,
    workstream: "L_public_secondary",
    classification: "DISCOVERY_ONLY",
    authorityTier: "secondary_explanation",
    officialStatus: "unofficial",
    reuseBasisRef: null,
    licenseOnFile: false,
    requiresExternalApproval: false,
    notesHe: "קטגוריה מוצהרת — תוכן משני לגילוי בלבד; יש לכבד רישוי כל מקור פרטני.",
  },
  // M — Academic / university legal publications ----------------------------
  {
    sourceKey: "il-academic-law",
    displayNameHe: "פרסומים אקדמיים משפטיים (גישה פתוחה)",
    sourceOwner: "מוסדות אקדמיים",
    homeUrl: null,
    workstream: "M_academic",
    classification: "DISCOVERY_ONLY",
    authorityTier: "academic",
    officialStatus: "secondary",
    reuseBasisRef: null,
    licenseOnFile: false,
    requiresExternalApproval: false,
    notesHe: "קטגוריה מוצהרת — כתבי-עת ופרסומי פקולטות למשפטים בגישה פתוחה; גילוי בלבד.",
  },
  // H (additional) — Government ministries & regulators ---------------------
  {
    sourceKey: "il-gov-ministries",
    displayNameHe: "אתרי משרדי הממשלה (gov.il)",
    sourceOwner: "מדינת ישראל",
    homeUrl: "https://www.gov.il",
    workstream: "H_regulatory_guidance",
    classification: "OPEN_OFFICIAL_FULL_TEXT",
    authorityTier: "official_regulatory",
    officialStatus: "official",
    ...
    licenseOnFile: false,
    requiresExternalApproval: false,
    notesHe: "פרסומים והנחיות רשמיים של משרדי הממשלה — פתוח.",
  },
  {
    sourceKey: "il-tax-authority",
    displayNameHe: "הנחיות רשות המסים",
    sourceOwner: "רשות המסים בישראל",
    homeUrl: "https://www.gov.il/he/departments/israel_tax_authority",
    workstream: "H_regulatory_guidance",
    classification: "OPEN_OFFICIAL_FULL_TEXT",
    authorityTier: "official_regulatory",
    officialStatus: "official",
    ...
    licenseOnFile: false,
    requiresExternalApproval: false,
    notesHe: "חוזרים והחלטות מיסוי — פרסום רשמי פתוח.",
  },
  {
    sourceKey: "il-competition-authority",
    displayNameHe: "הנחיות רשות התחרות",
    sourceOwner: "רשות התחרות",
    homeUrl: "https://www.gov.il/he/departments/competition_authority",
    workstream: "H_regulatory_guidance",
    classification: "OPEN_OFFICIAL_FULL_TEXT",
    authorityTier: "official_regulatory",
    officialStatus: "official",
    ...
    licenseOnFile: false,
    requiresExternalApproval: false,
    notesHe: "גילויי דעת והחלטות — פרסום רשמי פתוח.",
  },
