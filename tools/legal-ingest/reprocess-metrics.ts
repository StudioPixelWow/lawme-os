...
export function computeReprocessMetrics(records: ReprocessPageRecord[], publicationsAttempted: number) {
  ...
  return {
    ...
    publications_completed: new Set(records.map((r) => r.publication_item_id)).size,
    total_pages: total,
