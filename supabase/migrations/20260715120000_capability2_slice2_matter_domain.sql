...
--   Migration version: 20260715120000 (present exactly once in remote history).
--   Original applied   full-file SHA-256:
--     62a35d6c38e784d43a3cac089ca18a642d2b50d14fdfdadee5d303022f3c4f0e
--   Production:        NEVER touched.
--
--   HISTORICAL ACCURACY NOTE (Platform 0.7.1 reconciliation, 2026-07-21)
--     `app.forbid_established_fact_on_insert()` below is restored to the EXACT
--     form originally executed (NO `set search_path`). An out-of-band change had
--     added `set search_path = public` to this file after apply (commit d0ad94b)
--     and to the live function; that hardening is NOT part of this historical
--     migration and has been REMOVED here. It is recorded properly in the
--     additive migration 20260721_platform071_app_function_grant_hardening.sql.
--     Do NOT edit this file to pretend later hardening originated here.
--
